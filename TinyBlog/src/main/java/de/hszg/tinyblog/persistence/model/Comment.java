...
public class Comment {
	...
	/**
	 * This constructor is used for comments created by users that are logged
	 * in.
	 * 
	 * @param user
	 ...
	 *            The text of the comment.
	 */
	public Comment(final String name, final String email, final String content) {
		this(content);
		this.name = name;
		this.email = email;
	}
	...
	/**
	 * Private constructor to avoid code duplication. Is called with
